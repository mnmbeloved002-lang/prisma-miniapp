...
// biome-ignore lint/style/noDefaultExport: Vercel handler requires default export
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (!expectedSecret || providedSecret !== expectedSecret) {
    ...
    // biome-ignore lint/security/noSecrets: standard HTTP error message, not a real secret
